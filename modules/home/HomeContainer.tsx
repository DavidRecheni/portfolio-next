    ...
    <div className="flex flex-col relative h-screen text-white">
      ...
      <div className="h-full w-screen flex items-center justify-between px-2 sm:px-16 xl:px-36">
        <div className="flex flex-col">
          <div className="flex flex-col text-[100px] md:text-[150px] 2xl:text-[200px] antialiased">
            <h1 className="font-['Abhaya\\Libre'] md:-mb-10 2xl:-mb-20 ">
              David
            </h1>
            <h1 className="font-['Abhaya\\Libre'] -mt-16 -mb-8">Recheni</h1>
          </div>
          <div className="text-4xl 2xl:text-5xl text-slate-300 font-light">
