          ...
          <div className="flex flex-col mt-6 max-w-md font-light">
            ...
            <div className="pt-4 flex items-center gap-4">
              <button
                ...
                className="text-lg sm:text-xl bg-white text-black font-normal px-3 pt-1 pb-2 rounded-sm hover:bg-white border border-white hover:bg-transparent hover:text-white transition-colors duration-300 ease-in-out"
              >
                Get in touch
              </button>
            </div>
