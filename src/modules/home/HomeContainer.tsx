  ...
  return (
    <>
      <section
        ...
        id="main"
      >
        <div className="col-start-2 sm:col-start-5 lg:col-start-6 row-start-1 col-span-4 lg:col-span-2 z-10 mt-4 sm:mt-0">
        ...
        <div className="row-start-1 col-start-1 col-span-7 row-span-12 p-6 grid grid-rows-10 grid-cols-4 sm:grid-cols-6 gap-4">
